...
public class EffectMasterHandler
{
	...
	public static void main(String[] args)
	{
		...
		EffectHandler.getInstance().registerHandler("BowAttackReuse", BowAttackReuse::new);
		...
		EffectHandler.getInstance().registerHandler("ChanceToChain", ChanceToChain::new);
		...
		EffectHandler.getInstance().registerHandler("RebalanceMP", RebalanceMP::new);
		...
		EffectHandler.getInstance().registerHandler("TransferDamageToMP", TransferDamageToMana::new);
		...
		EffectHandler.getInstance().registerHandler("TrueDamage", TrueDamage::new);
