	...
	public void pump(Creature effected, Skill skill)
	{
		if ((_condition == null) || _condition.test(effected, effected, skill))
		{
			switch (_mode)
			{
				...
				case ADD:
				{
					effected.getStat().mergeAddMul(Stat.RUN_SPEED, (_amount / 100) + 1);
					effected.getStat().mergeAddMul(Stat.WALK_SPEED, (_amount / 100) + 1);
					effected.getStat().mergeAddMul(Stat.SWIM_RUN_SPEED, (_amount / 100) + 1);
					effected.getStat().mergeAddMul(Stat.SWIM_WALK_SPEED, (_amount / 100) + 1);
					effected.getStat().mergeAddMul(Stat.FLY_RUN_SPEED, (_amount / 100) + 1);
					effected.getStat().mergeAddMul(Stat.FLY_WALK_SPEED, (_amount / 100) + 1);
					break;
