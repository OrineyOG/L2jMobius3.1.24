...
public abstract class AbstractStatEffect extends AbstractEffect
{
	...
	protected final Stat _addmulStat;
	...
	{
		this(params, stat, stat, stat);
	}
	
	public AbstractStatEffect(StatSet params, Stat mulStat, Stat addStat, Stat addmulStat)
	{
		_addStat = addStat;
		_mulStat = mulStat;
		_addmulStat = addmulStat;
	...
	public void pump(Creature effected, Skill skill)
	{
		...
		switch (_mode)
		{
			...
			case ADD:
			{
				effected.getStat().mergeAddMul(_addmulStat, (_amount / 100) + 1);
				break;
			}
		}
	}
