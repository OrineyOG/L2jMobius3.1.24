...
public class EffectList
{
	...
	/**
	 * Gets all the active self-buffs on this effect list.
	 * @return all the self-buffs on this effect list
	 */
	public List<BuffInfo> getSelfBuffs()
	{
		final List<BuffInfo> result = new LinkedList<>();
		for (BuffInfo info : _actives)
		{
			if (info.getSkill().getBuffType().isSelfbuff())
			{
				result.add(info);
			}
		}
