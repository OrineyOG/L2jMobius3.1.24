...
public abstract class ItemTemplate extends ListenersContainer implements IIdentifiable
{
	...
	/**
	 * @return return General item grade (including S80, S84, R95, R99)
	 */
	public ItemGrade getDetailedItemGradeForEnchant()
	{
		ItemGrade detailedGrade = ItemGrade.valueOf(_crystalType.name());
