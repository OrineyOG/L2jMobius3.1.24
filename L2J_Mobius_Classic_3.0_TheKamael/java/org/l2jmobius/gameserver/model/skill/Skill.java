...
public class Skill implements IIdentifiable
{
	...
	public Skill(StatSet set)
	{
		...
		_isSelfbuff = set.getBoolean("isSelfbuff", false);
		...
		_buffType = _isTriggeredSkill ? SkillBuffType.TRIGGER : isToggle() ? SkillBuffType.TOGGLE : isDance() ? SkillBuffType.DANCE : _isDebuff ? SkillBuffType.DEBUFF : _isSelfbuff ? SkillBuffType.SELFBUFF : !isHealingPotionSkill() ? SkillBuffType.BUFF : SkillBuffType.NONE;
